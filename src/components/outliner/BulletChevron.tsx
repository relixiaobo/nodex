...
export function ChevronButton({
  ...
  return (
    <Tooltip label={isExpanded ? 'Collapse' : 'Expand'}>
      ...
      >
        <div
          className={`flex h-[15px] w-[15px] items-center justify-center rounded-full bg-foreground/[0.06] outline outline-2 outline-background transition-colors ${isExpanded ? '[&>svg]:rotate-90' : ''
            }`}
        >
          <svg
            width="10"
