...
| nodex-codex | Refactor — Row 交互统一（content node + trailing input + field value） | codex/row-interaction-unify | docs/TASKS.md, docs/TESTING.md, docs/features/outliner-interactions.md, src/lib/row-interactions.ts, src/lib/node-editor-shortcuts.ts, src/lib/trailing-input-navigation.ts, tests/vitest/row-interactions.test.ts, tests/vitest/node-editor-shortcuts.test.ts, tests/vitest/trailing-input-navigation.test.ts |
...
> **Files**: `src/lib/row-interactions.ts`, `src/lib/node-editor-shortcuts.ts`, `src/lib/trailing-input-navigation.ts`, `tests/vitest/row-interactions.test.ts`, `tests/vitest/node-editor-shortcuts.test.ts`, `tests/vitest/trailing-input-navigation.test.ts`, `docs/features/outliner-interactions.md`, `docs/TESTING.md`
> **Progress**:
