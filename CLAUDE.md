...
- **Issue 跟踪**: [GitHub Issues](https://github.com/relixiaobo/nodex/issues) + [Nodex Board](https://github.com/users/relixiaobo/projects/1)（`docs/issues.md` 已废弃）
...
- **Agent 自我识别**: 通过 clone 路径 / 端口 / 分支判断自己是哪个 Agent，详见 `docs/AGENT-COLLABORATION.md`
