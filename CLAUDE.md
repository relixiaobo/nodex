...
- **角色分工**: `nodex`（主 clone）= Review + Merge；`nodex-codex` / `nodex-cc` = 功能开发 + 提 PR
- **Git 分支**: `codex/<feature>` 或 `cc/<feature>`，功能开发通过 PR 合入 main
...
- **Dev Server 端口**: 主 clone `5199`，nodex-codex `PORT=5200`，nodex-cc `PORT=5201`
