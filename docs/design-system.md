...
- **精致感**：强调色饱和度适中，在浅色背景上清晰但不刺眼；Dark mode 下可适当提亮
...
| `--primary` | `#7C3AED` | 主色（亮紫，饱和度高，白底对比度 5.2:1） |
| `--primary-hover` | `#6D28D9` | 主色 hover（加深） |
| `--primary-muted` | `rgba(124,58,237,0.08)` | 主色背景（选中行、badge） |
...
|------|------|-----------|---------|------------|----------|
| 0 | Violet | `#A5A0FC` | `rgba(124,107,244,0.15)` | `#7C3AED` | `rgba(124,58,237,0.08)` |
