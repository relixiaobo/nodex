...
| ~~`props._metaNodeId`~~ | ~~`meta_node_id`~~ | ~~已移除 (migration 004)~~ |
...
| ~~`associationMap`~~ | ~~`association_map`~~ | ~~已移除 (migration 004)~~ |
