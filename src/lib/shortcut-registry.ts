 ...
 *
 * Note:
 * - Runtime bindings are still distributed across RichTextEditor/TrailingInput/hooks.
...
export const SHORTCUT_REGISTRY: ShortcutDefinition[] = [
  ...
  },
  {
    ...
    scope: 'node_editor',
    keys: ['Backspace'],
    when: 'RichTextEditor focused and current node is empty',
  ...
  },
  {
    ...
    scope: 'node_editor',
    keys: ['Escape'],
    when: 'RichTextEditor focused with active dropdown',
  ...
  },
  {
    ...
    scope: 'node_editor',
    keys: ['Mod-Enter'],
    when: 'RichTextEditor focused with #/@ dropdown open',
