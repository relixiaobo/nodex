...
import { Library, Inbox, CalendarDays, Trash2, Search, Settings, Bot, Code2, MoreHorizontal, type AppIcon } from '../../lib/icons.js';
            ...
            {editing ? (
              <>
                <RichTextEditor
                  ...
                  mountClassName="text-xl font-semibold leading-7"
                  onBlur={handleBlur}
                  onEnter={handleEnter}
                  onIndent={noop}
                  onOutdent={noop}
