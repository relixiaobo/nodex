 ...
 if (!authUser) {
  return (
   <button
    ...
    disabled={signingIn}
    className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-foreground-secondary transition-colors hover:bg-foreground/4 disabled:opacity-50"
