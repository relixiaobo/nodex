   ...
   <div className="inline-flex items-center gap-1.5">
    ...
    <div className="inline-flex items-center gap-px rounded-md overflow-hidden">
     <button
      ...
      className="flex h-6 w-6 items-center justify-center bg-foreground/4 hover:bg-foreground/[0.09] transition-colors"
    ...
    <div className="inline-flex items-center gap-px rounded-md overflow-hidden">
     <button
      onClick={handleToday}
      className="flex h-6 items-center px-2 text-xs font-medium bg-foreground/4 hover:bg-foreground/[0.09] transition-colors"
     ...
     <button
      ...
      className={`flex h-6 w-6 items-center justify-center transition-colors ${
       calendarOpen
        ...
        : 'bg-foreground/4 hover:bg-foreground/[0.09]'
      }`}
