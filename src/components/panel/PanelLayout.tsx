    ...
    return (
      <div ref={containerRef} className="flex flex-1 flex-col overflow-hidden">
        ...
        <div className="flex items-end shrink-0">
          <div
            ref={notesMenuRef}
            className="tab-connector-right relative z-10 flex h-10 shrink-0 items-center bg-background rounded-t-xl"
          >
            <button
              type="button"
        ...
        if (hasTab) {
          return (
            <div key={panel.id} className="flex flex-1 min-w-0 flex-col">
              ...
              <div className="flex items-end shrink-0">
                <div
                  className={`tab-connector-right relative z-10 flex h-10 items-center bg-background rounded-t-xl ${isChat ? 'shrink-0' : 'min-w-0 shrink'}`}
