...
export function seedTestData() {
  ...
  const sysT01Nodes: NodexNode[] = [
    ...
    makeNode('sysT01_tpl_done_mapping', '', 'SYS_T01', [SYS_A.DONE_STATE_MAPPING, 'sysT01_tpl_done_map_checked', 'sysT01_tpl_done_map_unchecked'], 'tuple'),
    makeNode('sysT01_tpl_done_map_checked', '', 'sysT01_tpl_done_mapping', [SYS_A.DONE_MAP_CHECKED], 'tuple'),
    makeNode('sysT01_tpl_done_map_unchecked', '', 'sysT01_tpl_done_mapping', [SYS_A.DONE_MAP_UNCHECKED], 'tuple'),
  ];
  ...
  const tagDefTaskConfigNodes: NodexNode[] = [
    ...
    makeNode('tagDef_task_cfg_done_mapping', '', 'tagDef_task', [SYS_A.DONE_STATE_MAPPING, SYS_V.YES, 'tagDef_task_cfg_done_checked_1', 'tagDef_task_cfg_done_unchecked_1'], 'tuple'),
    makeNode('tagDef_task_cfg_done_checked_1', '', 'tagDef_task_cfg_done_mapping', [SYS_A.DONE_MAP_CHECKED, 'attrDef_status', 'opt_done'], 'tuple'),
    makeNode('tagDef_task_cfg_done_unchecked_1', '', 'tagDef_task_cfg_done_mapping', [SYS_A.DONE_MAP_UNCHECKED, 'attrDef_status', 'opt_todo'], 'tuple'),
  ];
